...
#           linear map and return, without relocating a single page.
# The probe path uses only caller-saved x0-x5 so returning to C obeys AArch64
...
echo 'TICWATCH_ARM64_RELOC_PROBE2=TTBR1_BBM_RETURN_NO_PAGE_RELOCATION'
